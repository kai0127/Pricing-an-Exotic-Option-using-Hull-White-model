#  Copyright (c) 2022/5/5 下午6:32 Last Modified By Kaiwen Zhou
...
class Bond_Data(object):
    ...
    def __init__(self, url):
        ...
        # generate the piecewise cubic (bounded by k = 3) spline; s=0 is use to suggest smoothness (normally zero)
